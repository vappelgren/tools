...
/**
* Selecciona el lenguaje por defecto
*
...
/**
* Genera la traducción de la cadena
*
...
/**
* Establecer fondo transparente para QRcode
*
...
/**
 * Aumenta o disminuye el brillo de un color en un porcentaje del brillo actual.
 *
...
function getBtcRates()
{
    ...
    if (file_exists($cache_file)) {
        // si el archivo tiene 24 horas (86400 segundos) de antigüedad, vuelva a generar.
